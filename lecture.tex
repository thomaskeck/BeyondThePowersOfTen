...
\begin{frame}{Bullet Cluster}
	\centering
	\begin{tikzpicture}
	\node at (0,0) {\includegraphics[width=0.8\textwidth]{bulletcluster.jpg}};
	\end{tikzpicture}	
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		...
		\end{columns}
		\vspace*{1em}
		\onslide<2>{EM Wellen $\rightarrow$ WLAN, Mobilfunk}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		...
		\end{columns}
		\vspace*{1em}
		\onslide<2>{Flüssigkristalle $\rightarrow$ LCD}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		...
		\vspace*{1em}
		\onslide<2>{Transistor $\rightarrow$ Prozessor, Elektronik}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		...
		\end{columns}
		\vspace*{1em}
		\onslide<2>{World Wide Web, HTML, HTTP}
	\end{center}
\end{frame}
